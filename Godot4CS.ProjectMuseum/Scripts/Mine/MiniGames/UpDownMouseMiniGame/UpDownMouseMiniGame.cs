...
namespace Godot4CS.ProjectMuseum.Scripts.Mine.MiniGames.UpDownMouseMiniGame;

public partial class UpDownMouseMiniGame : Node2D
{
    ...
    [Export] private bool _isMovingUp = true;
